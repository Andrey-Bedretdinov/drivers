...
parallels@ubuntu-gnu-linux-24-04-3:~/drivers/practice/3$ sudo insmod driver.ko
```
...
```shell
parallels@ubuntu-gnu-linux-24-04-3:~/drivers/practice/3$ lsmod | grep driver
driver                 12288  0
parallels@ubuntu-gnu-linux-24-04-3:~/drivers/practice/3$ sudo dmesg | tail -1
...
```shell
parallels@ubuntu-gnu-linux-24-04-3:~/drivers/practice/3$ ls -l /dev | grep pz3
crw-------  1 root root    234,   0 дек  7 02:21 pz3_dev
```
...
```shell
parallels@ubuntu-gnu-linux-24-04-3:~/drivers/practice/3$ gcc main.c -o main
parallels@ubuntu-gnu-linux-24-04-3:~/drivers/practice/3$ sudo ./main
...
```shell
parallels@ubuntu-gnu-linux-24-04-3:~/drivers/practice/3$ sudo dmesg | tail -40
[ 6445.528247] драйвер загружен, major=234
...
```shell
parallels@ubuntu-gnu-linux-24-04-3:~/drivers/practice/3$ sudo rmmod driver
parallels@ubuntu-gnu-linux-24-04-3:~/drivers/practice/3$ lsmod | grep driver
parallels@ubuntu-gnu-linux-24-04-3:~/drivers/practice/3$ sudo dmesg | tail -20
[ 6577.926238] драйвер выгружен
parallels@ubuntu-gnu-linux-24-04-3:~/drivers/practice/3$ 
```